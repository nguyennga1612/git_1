                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="address" name="address" placeholder="House number, street...." />
                                </div>
                            </div>
                            <div class="form-group row">
...
<script>
    ...
    function update_cart(id, value) {
        ...
        // $.ajax({
        //         url: 'http://localhost/WEBB_APP/public/ajax_cart/get_price',
        //         method: "post",
