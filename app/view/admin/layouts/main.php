...
<head>
    ...
    <!-- app favicon -->
    <link rel="shortcut icon" href="<?php echo  ROOT ?>assets/admin/img/favicon.ico">
    <!-- google fonts -->
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700" rel="stylesheet">
    <!-- plugin stylesheets -->
    <link rel="stylesheet" type="text/css" href="<?php echo  ROOT ?>assets/admin/css/vendors.css" />
    <!-- app style -->
    <link rel="stylesheet" type="text/css" href="<?php echo  ROOT ?>assets/admin/css/style.css" />
    <script src="<?php echo  ROOT ?>assets/admin/js/jquery-3.5.1.min.js"></script>
</head>
            ...
            <div class="loader">
                <div class="h-100 d-flex justify-content-center">
                    <div class="align-self-center">
                        <img src="<?php echo  ROOT ?>assets/admin/img/loader/loader.svg" alt="loader">
                    </div>
                </div>
            </div>
            <!-- end pre-loader -->
                ...
                <nav class="navbar navbar-expand-md">
                    ...
                    <div class="navbar-header d-flex align-items-center">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img src="<?php echo  ROOT ?>assets/admin/img/logo.png" class="img-fluid logo-desktop" alt="logo" />
                            <img src="<?php echo  ROOT ?>assets/admin/img/logo-icon.png" class="img-fluid logo-mobile" alt="logo" />
                        </a>
                    </div>
                            ...
                            <ul class="navbar-nav nav-right ml-auto">
                                                ...
                                                <ul class="scrollbar scroll_dark max-h-240">
                                                        ...
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?php echo  ROOT ?>assets/admin/img/avtar/03.jpg" alt="user3">
                                                                </div>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?php echo  ROOT ?>assets/admin/img/avtar/01.jpg" alt="user">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?php echo  ROOT ?>assets/admin/img/avtar/02.jpg" alt="user2">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?php echo  ROOT ?>assets/admin/img/avtar/04.jpg" alt="user4">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?php echo  ROOT ?>assets/admin/img/avtar/05.jpg" alt="user5">
                                                                </div>
                                                                <div class="notify-message">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)">
                                                            <div class="notification d-flex flex-row align-items-center">
                                                                <div class="notify-icon bg-img align-self-center">
                                                                    <img class="img-fluid" src="<?php echo  ROOT ?>assets/admin/img/avtar/06.jpg" alt="user6">
                                                                </div>
                                                                <div class="notify-message">
                                ...
                                <li class="nav-item dropdown user-profile">
                                    <a href="javascript:void(0)" class="nav-link dropdown-toggle " id="navbarDropdown4" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img src="<?php echo  ROOT ?>assets/admin/img/avtar/02.jpg" alt="avtar-img">
                ...
                <aside class="app-navbar">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="active">
                                <a  href="<?php echo ROOT?>home/index"aria-expanded="false" >
                                    <i class="nav-icon ti ti-rocket"></i>
                                    <span class="nav-title">Dashboards</span>
                                    
                                </a>
                            </li>
                            <li class="active"><a href="<?php echo ROOT?>admin_order/index" aria-expanded="false"><i class="nav-icon ti ti-calendar"></i><span class="nav-title">Order Management</span></a> </li>
